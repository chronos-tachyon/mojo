...
// Time represents an approximate instant of time.
// - It is guaranteed to have nanosecond precision.
// - It is guaranteed to have a range equal to time_t or better.
//
// Time is relative to an epoch. The Unix epoch (01 Jan 1970 00:00:00 UTC) is
// most commonly used, but the epoch is not included with the Time itself.
//
class Time {
 private:
