...
class FileSystemImpl {
 ...
 public:
  ...
  virtual void statfs(event::Task* task, StatFS* out, const std::string& path,
                      const base::Options& opts) const = 0;

  virtual void stat(event::Task* task, Stat* out, const std::string& path,
                    const base::Options& opts) const = 0;

  virtual void set_stat(event::Task* task, const std::string& path,
                        const SetStat& delta, const base::Options& opts) = 0;

  virtual void open(event::Task* task, File* out, const std::string& path,
                    Mode mode, const base::Options& opts) = 0;

  virtual void link(event::Task* task, const std::string& oldpath,
                    const std::string& newpath, const base::Options& opts) = 0;
