...
#ifndef CRYPTO_CIPHER_AES_INTERNAL_H
#define CRYPTO_CIPHER_AES_INTERNAL_H
...
void aes_expand_key(AESState* state, const uint8_t* key,
                    std::size_t len);
void aes_expand_key(AESState* state, base::Bytes key);

void aes_encrypt(const AESState* state, uint8_t* dst, const uint8_t* src,
                 std::size_t len) noexcept;
void aes_encrypt(const AESState* state, base::MutableBytes dst, base::Bytes src) noexcept;

void aes_decrypt(const AESState* state, uint8_t* dst, const uint8_t* src,
                 std::size_t len) noexcept;
void aes_decrypt(const AESState* state, base::MutableBytes dst, base::Bytes src) noexcept;
...
static constexpr uint8_t POW_X[16] = {
    0x01U, 0x02U, 0x04U, 0x08U, 0x10U, 0x20U, 0x40U, 0x80U,
    0x1bU, 0x36U, 0x6cU, 0xd8U, 0xabU, 0x4dU, 0x9aU, 0x2fU,
};

static constexpr uint8_t SBOX_0[256] = {
...
static constexpr uint8_t SBOX_1[256] = {
...
static constexpr uint32_t TE_0[256] = {
...
static constexpr uint32_t TE_1[256] = {
...
static constexpr uint32_t TE_2[256] = {
...
static constexpr uint32_t TE_3[256] = {
...
static constexpr uint32_t TD_0[256] = {
...
static constexpr uint32_t TD_1[256] = {
...
static constexpr uint32_t TD_2[256] = {
...
static constexpr uint32_t TD_3[256] = {
...
#endif  // CRYPTO_CIPHER_AES_INTERNAL_H
